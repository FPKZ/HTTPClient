...
const LogConsole = ({ logs }) => {
  ...
  return (
    <div className="log-container flex-grow-1 bg-black border border-secondary rounded p-2 overflow-auto" style={{ fontFamily: 'monospace', fontSize: '12px', minHeight: '100px' }}>
