      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="
            ...
            focus:outline-none z-50 animate-in zoom-in-95 duration-200
            flex flex-col p-0 overflow-hidden
          "
        >
          {/* Header Fixo */}
          <div className="flex items-center justify-between p-3 pb-2 border-b border-zinc-800/50 bg-zinc-950/20">
            ...
            <Dialog.Close asChild>
              <button className="text-zinc-500 hover:text-white transition-colors border-none bg-transparent cursor-pointer outline-none p-1">
                <X size={20} />
              </button>
            </Dialog.Close>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 text-zinc-300 scrollbar-thin scrollbar-thumb-zinc-700">
            <section>
              ...
              <p className="text-xs! leading-relaxed m-0 text-left">
            ...
            <section>
              ...
              <p className="text-xs! mb-3 text-left">
                Para usar uma variável, envolva o nome dela em chaves duplas:
              </p>
              <div className="bg-zinc-950 p-3 rounded border border-zinc-800! font-mono text-[0.75rem] text-yellow-500/90 italic shadow-inner">
                {"{{nome_da_variavel}}"}
              </div>
            </section>

            <section>
              <h3 className="text-sm! font-bold text-white mb-3 uppercase tracking-wide text-left">
                Exemplos Práticos
              </h3>
              <div className="space-y-3">
                ...
                <div className="bg-zinc-800/50 p-3 rounded border border-zinc-700/50!">
                  ...
                  <pre className="text-[0.65rem] text-zinc-400 mt-1 font-mono bg-zinc-900/50 p-2 rounded">
                    {`{
  "email": "{{admin_email}}",
  "apiKey": "{{secret_key}}"
}`}
            ...
            <div className="bg-blue-500/10 border border-blue-500/20! p-4 rounded-lg flex gap-3">
              ...
              <p className="text-[0.7rem]! leading-relaxed text-blue-300 m-0 text-left">
          ...
          {/* Footer Fixo */}
          <div className="flex justify-end p-3 border-t border-zinc-800/50 bg-zinc-950/20">
            <Dialog.Close asChild>
              <button className="bg-yellow-600 text-white px-6 py-2 rounded text-xs! font-bold hover:bg-yellow-700 transition-all shadow-lg shadow-yellow-600/20 active:scale-95 border-none cursor-pointer">
                Entendi
              </button>
            </Dialog.Close>
          </div>
