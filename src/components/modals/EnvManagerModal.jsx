    ...
    <>
      <Dialog.Root open={open} onOpenChange={onOpenChange}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 min-w-[80%]! max-w-[95%]! max-h-[95%]! bg-zinc-950 rounded-xl border border-zinc-800! shadow-2xl overflow-hidden flex flex-col z-50 outline-none animate-in zoom-in-95 duration-200">
                    ...
                    <div className="p-2 flex flex-col gap-1 overflow-y-auto h-full">
                      ...
                      <div className="mt-2 pt-2 border-t border-zinc-800!">
                        <button
                          ...
                          className="flex items-center gap-3 px-3 py-2.5 w-full rounded-lg! hover:bg-yellow-500/10 text-yellow-500 transition-colors text-left group"
                        >
                          <Plus size={18} />
                              ...
                              <tr className="bg-zinc-900/20">
                                <td colSpan={4} className="p-0">
                                  <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-3 text-sm text-zinc-500 hover:text-yellow-500 hover:bg-yellow-500/5 transition-all"
                                  >
                                    <PlusCircle size={18} />
                        ...
                        <div className="mt-8 border-t border-zinc-800! pt-6 mb-4">
                          ...
                          >
                            <div className="flex items-center gap-2 text-yellow-500">
                              <Info size={18} />
                              <h3 className="text-base! font-bold text-white m-0 group-hover/help:text-yellow-500 transition-colors">
                          ...
                          {isHelpOpen && (
                            <div className="space-y-6 mt-6 animate-in slide-in-from-top-2 duration-200">
                              ...
                              <section className="bg-zinc-900/40 p-4 rounded-lg border border-zinc-800/50!">
                                <h4 className="text-xs! font-bold text-white mb-3 uppercase tracking-wide">
                                  Exemplos Práticos
                                </h4>
            ...
            <div className="px-2 py-2.5 border-t border-zinc-800 bg-zinc-900/50 flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <Dialog.Close asChild>
                  <button className="h-10 px-3 rounded-lg! bg-zinc-800 text-zinc-300 text-sm! font-bold hover:bg-zinc-700 transition-colors">
                    Cancelar
                  </button>
                </Dialog.Close>
                <Dialog.Close asChild>
                  <button className="h-10 px-3 rounded-lg! bg-yellow-600 text-zinc-950 text-sm! font-bold hover:bg-yellow-500 transition-all shadow-lg shadow-yellow-600/10!">
                    Fechar
                  </button>
                </Dialog.Close>
              </div>
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div className="flex gap-3 w-full mt-2">
                <button
                  ...
                  className="flex-1 h-10 rounded-lg! bg-zinc-800 text-zinc-300 text-sm font-bold hover:bg-zinc-700 transition-colors"
                >
                  Cancelar
                </button>
                <button
                  onClick={confirmDeleteEnv}
                  className="flex-1 h-10 rounded-lg! bg-red-600 text-white text-sm font-bold hover:bg-red-500 transition-colors shadow-lg shadow-red-600/10"
                >
                  Confirmar
                </button>
              </div>
